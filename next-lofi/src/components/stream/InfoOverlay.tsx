  ...
  return (
    <div className="absolute bottom-0 left-0 w-full p-3 sm:p-6 z-30 flex flex-col gap-2 sm:gap-4">
      <div className="flex flex-col md:flex-row gap-4 items-end justify-between">
            ...
            <div className="flex items-start justify-between mb-2 sm:mb-4 gap-2">
              <div className="min-w-0 flex-1">
                ...
                <h2 className="text-xl sm:text-3xl font-light text-white tracking-wide flex items-start sm:items-center gap-2 sm:gap-3">
                  ...
                  <span className="break-words whitespace-normal leading-tight">{location?.name || 'CALIBRATING...'}</span>
                </h2>
        ...
        <div className="hidden sm:block bg-black/50 backdrop-blur-xl border border-white/10 rounded-2xl p-4 w-full md:w-[540px] h-36 flex flex-col shadow-2xl overflow-hidden relative">
          <style>{`
